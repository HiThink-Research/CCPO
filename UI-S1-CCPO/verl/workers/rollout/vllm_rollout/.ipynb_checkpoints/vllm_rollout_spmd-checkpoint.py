    ...
    def generate_sequences(self, prompts: DataProto, **kwargs) -> DataProto:
        ...
        if not do_sample:
            ...
            kwargs = {
                ...
                "n": 8,  # if validate, already repeat in ray_trainer
            }
            # kwargs = {
            #     # "top_k": self.config.val_kwargs.top_k,
            #     # "top_p": self.config.val_kwargs.top_p,
            ...
            pass
        # print("vllm rollout kwargs:", kwargs)
        lora_requests = None
        if self.lora_kwargs:
        ...
        # print('vllm response:', [self.tokenizer.decode(ids, skip_special_tokens=True) for ids in response])
