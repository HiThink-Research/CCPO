...
def check_click(click, candidate_bbox, gt_point):
    ...
    # If you want to validate the click against candidate bounding boxes:
    # if candidate_bbox:
...
def enlarge_bbox(bbox_list, scale_factor=1.2) -> np.ndarray:
    """
    Enlarge each bounding box by a certain scale factor.

    :param bbox_list: A list of bounding boxes. Each bbox is a tuple or list of four values:
                      (xmin, ymin, xmax, ymax)
    :param scale_factor: Scale factor for enlargement
    :return: A list/array of enlarged bounding boxes
    """
