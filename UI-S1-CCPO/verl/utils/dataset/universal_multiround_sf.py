...
class StdTrajectory():
    def __init__(self, line,actions_only) -> None:
        ...
        self.fm = JsonFormat(RAW_SPACE, add_thought=False, force_add_thought=False,actions_only=actions_only)
        self.state = None
...
class StdTrajectorySF():
    def __init__(self, line,actions_only) -> None:
        ...
        from x.data.agent.space.std_space import RAW_SPACE
        self.fm = JsonFormatSF(RAW_SPACE, add_thought=False, force_add_thought=False,actions_only=actions_only)
        self.state = None
