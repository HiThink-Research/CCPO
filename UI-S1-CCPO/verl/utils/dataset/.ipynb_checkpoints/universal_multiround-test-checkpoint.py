...
class MultiRoundGenerator():
    ...
    def _fetch_next(self, ptr):
        ...
        state["previous_aggregate_coordinates"]= self.previous_aggregate_coordinates[example_group].copy()
    ...
    def aggregate_previous_coordinates(self, ptr):
        ...
        # Important! As pre_reference added at runtime
        ...
        # print(f"keys: {self._previous_aggregate_keys[example_group]}")
        # print(aggregate_coords)
...
if __name__ == "__main__":
    ...
    #print(batch)
    i = 0
    mr_gen = MultiRoundGenerator(batch, rollout_n=3, msg_man=msg_man)
