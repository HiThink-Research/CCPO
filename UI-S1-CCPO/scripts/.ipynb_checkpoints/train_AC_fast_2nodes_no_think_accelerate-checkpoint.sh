...
EXPERIMENT_NAME="qwenvl_uis1_DAPO_${DAPO}_${DAPO_THRESHOLD}_patch_${PATCH_THRESHOLD}_gamma_${GAMMA}_fast_2_images_2_nodes_CCPO_no_think_SFT_lora_bz8_3000"
if [ $MASTER_ADDR ];then
    echo $MASTER_ADDR
    echo $MASTER_PORT
    echo $WORLD_SIZE
...
"
    ...
    python3 -m verl.trainer.main_dapo \
        ...
        actor_rollout_ref.model.path=/mnt/HithinkOmniSSD/user_workspace/songyurun/AC_SFT/7B_1AO_bz8_sequence_baseline_lora_new/merge/checkpoint-3000 \
