...
export PYTHONFAULTHANDLER=1   # richer crash info, if any remain
...
EXPERIMENT_NAME="qwenvl_uis1_DAPO_${DAPO}_${DAPO_THRESHOLD}_patch_${PATCH_THRESHOLD}_gamma_${GAMMA}_fast_2_images_4_nodes_no_think_SFT"
if [ $MASTER_ADDR ];then
    echo $MASTER_ADDR
    echo $MASTER_PORT
    echo $WORLD_SIZE
...
required_gpus = 32  # 在此处硬编码需要的GPU数量
timeout = 800
...
"
    ...
    python3 -m verl.trainer.main_dapo \
        ...
        actor_rollout_ref.model.path=/mnt/HithinkOmniSSD/user_workspace/songyurun/AC_SFT/7B_1AO_bz16_sequence_baseline_lora/merge/checkpoint-1200 \
