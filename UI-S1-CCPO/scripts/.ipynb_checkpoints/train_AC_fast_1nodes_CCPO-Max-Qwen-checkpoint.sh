...
EXPERIMENT_NAME="qwenvl_uis1_DAPO_${DAPO}_${DAPO_THRESHOLD}_patch_${PATCH_THRESHOLD}_gamma_${GAMMA}_fast_CCPO_3AO_1_nodes_noterm_nothink_Qwen_MAX"
if [ $MASTER_ADDR ];then
    echo $MASTER_ADDR
    echo $MASTER_PORT
    echo $WORLD_SIZE
...
required_gpus = 8  # 在此处硬编码需要的GPU数量
timeout = 800
