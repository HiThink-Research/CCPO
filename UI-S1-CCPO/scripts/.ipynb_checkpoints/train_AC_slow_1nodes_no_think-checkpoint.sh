...
EXPERIMENT_NAME="qwenvl_uis1_DAPO_${DAPO}_${DAPO_THRESHOLD}_patch_${PATCH_THRESHOLD}_gamma_${GAMMA}_fast_2_images_1_nodes_3B_no_think"
if [ $MASTER_ADDR ];then
    echo $MASTER_ADDR
    echo $MASTER_PORT
    echo $WORLD_SIZE
...
if [ "$RANK" == "0" ]; then
    ...
    python3 -m verl.trainer.main_dapo \
        ...
        data.max_prompt_length=24567 \
        data.max_response_length=512 \
        data.truncation='left' \
        actor_rollout_ref.model.path=/mnt/HithinkOmni/user_workspace/songyurun/models/Qwen2.5-VL-3B-Instruct \
